...
public class UsuariosD extends IDao{
	...
	public void inserir(Object o) {
            ...
            try { 
                String sql = "INSERT INTO "+ Tabela +" (nome,senha,email,descricao,foto) VALUES"
                        + " ('"+u.getNome()+"','"+u.getSenha()+"','"+u.getEmail()+"','"+u.getDescricao()+"','"+u.getFoto()+"');";
	...
	public void alterar(Object o) {
            ...
            try {
                bd.execComando("UPDATE " + Tabela + " SET nome='" + u.getNome() + "',senha='" + u.getSenha() + "',"
                             + "email='" + u.getEmail() + "',descricao='" + u.getDescricao() + "', foto='" + u.getFoto() + "'"
                             + " WHERE id=" + u.getId());
            } catch (Exception ex) {
	...
	public void deletar(Object o) {
        ...
        public Object pesquisar(Object key) {
            if (!(key instanceof Integer))
                throw new IllegalArgumentException("Chave de pesquisa inválida. [Requer Inteiro]");
                
            try {
                String SQL = "SELECT * FROM " + Tabela + " WHERE id=" + key;
