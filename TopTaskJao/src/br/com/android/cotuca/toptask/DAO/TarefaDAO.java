...
public class TarefaDAO {
	...
	public static Tarefa getCursor(Cursor c) {
		...
		String foto = c.getString(c.getColumnIndex(ContratoTarefas.Colunas.FOTO));

		return new Tarefa(_id,nome, descricao,dono,data, prioridade, projeto,concluida,foto);
	}
	...
	public void save(Tarefa tarefa) {
		...
		values.put(ContratoTarefas.Colunas.FOTO, tarefa.getFoto());
